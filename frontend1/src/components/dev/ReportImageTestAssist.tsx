...
const ENABLED =
  import.meta.env.VITE_DEV_REPORT_IMAGE_TOOLS === "true" ||
  import.meta.env.VITE_DEV_REPORT_IMAGE_TOOLS === "1";
...
/**
 * Bật khi VITE_DEV_REPORT_IMAGE_TOOLS=true:
 * tải ảnh PNG test, xem trước file chọn từ máy, hướng dẫn copy ảnh cố định cho Swagger.
 */
